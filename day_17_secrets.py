...
st.write(
    "The following code can be used to access the variables in the _.streamlit/secrets.toml_ file"
)
...
st.write(
    "Alternatively the variables can be accessed by accessing environment variables"
)
