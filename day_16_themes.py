...
st.write("The theme of a streamlit app can be modified by changing the _config.toml_ file")
...
st.write("More details on themes can be found [here](https://docs.streamlit.io/library/advanced-features/theming)")
